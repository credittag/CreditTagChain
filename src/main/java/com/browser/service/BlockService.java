...
public interface BlockService {
	...
	/**
	 * 
	 * @Title: queryByCount @Description:判断块表是否有数据 @author David @param @return
	 * int  @throws
	 */
	int queryByCount();
	...
	/**
	 * 
	 * @Title: queryBlockNum @Description:获取最大的快号 @author David @param @return
	 * int  @throws
	 */
	Long queryBlockNum();
	...
	/**
	 * 
	 * @Title: insertSelective @Description:保存快信息 @author David @param @return
	 * int  @throws
	 */
	...
	/**
	 * 
	 * @Title: selectByNewData @Description:查询最新的5条记录 @author
	 * David @param @return List<TblBcBlock>  @throws
	 */
	String selectByNewData();

	/**
	 * 
	 * @Title: selectByPrimaryKey @Description:根据blockId查询快信息 @author
	 * David @param @return TblBcBlock  @throws
	 */
	...
	/**
	 * 
	 * @Title: search @Description:搜索 @author David @param @return
	 * String  @throws
	 */
	...
	EUDataGridResult queryBlockList(Integer page, Integer rows,TblBcBlock tblBcBlock);
