...
public class TblContractInfo {
	...
	private TblContractTokenInfo tblContractTokenInfo; // 代币合约

	public TblContractTokenInfo getTblContractTokenInfo() {
		return tblContractTokenInfo;
	}

	public void setTblContractTokenInfo(TblContractTokenInfo tblContractTokenInfo) {
		this.tblContractTokenInfo = tblContractTokenInfo;
	}
	...
	public BigDecimal getBalanceBig() {
		// return new BigDecimal(balance).divide(new
		// BigDecimal(Constant.PRECISION));
		return balanceBig;
	}
