...
public class SocketServiceImpl implements SocketService {
	...
	@Override
    public String getBalanceByAddress(String address,Socket socket,PrintWriter os,BufferedReader is) {
		List<Object> params = new ArrayList<Object>();
		params.add(address);
		return send2(RpcLink.BLOCKCHAIN_LIST_ADDRESS_BALANCES,params,socket,os,is);
    }
